...
[Table("CosmaWaveInitiatives", Schema = "readacross")]
public class CosmaWaveInitiative
{
    ...
    /// <summary>Comma-delimited archetype names — Cosma only.</summary>
    [MaxLength(512)] public string? Archetypes { get; set; }
